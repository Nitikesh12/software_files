...
import time
tv=TvDatafeed()
df = tv.get_hist(symbol='NIFTY',exchange='NSE',interval=Interval.in_daily,n_bars=602)
...
new_df.to_csv("krishan1.csv",columns=["date","4high","4low","range","close_ava","4per","monday_open","open-4high","open-4low","open-4high_p","open-4low_p","high_rolling4","low_rolling4"])
print(new_df)
